...
namespace DBA.Repository
{
    ...
    public class UserRepository : ContextRepository
    {
        ...
        public User Add(User us)
        {
            ...
            us.is_active = true;
            using ManageContext context = GetContext();
        ...
        public bool Delete(int userId)
        {
            ...
            try
            {
                ...
                User u = context.Users.First(u => u.UserId == userId);
                u.is_active = false;
                context.SaveChanges();
                return true;
            }
        ...
        public bool Login(string username, string password)
        {
            ...
            User u = GetContext().Users.FirstOrDefault(u => u.UserName == username && u.Password == password && u.is_active == true);
            return u != null;
        }
    }
}
